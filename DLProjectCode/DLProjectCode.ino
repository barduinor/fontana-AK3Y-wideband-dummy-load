...
float autorange(float sum) {
  if ((sum>=0) && (sum<=1)) return 1; else
  if ((sum>1) && (sum<=10)) return 10; else
  if ((sum >10) && (sum<=100)) return 100;
}
